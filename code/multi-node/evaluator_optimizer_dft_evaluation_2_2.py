...
# Configuration - This will be dynamically modified by run_evaluation_10_times.py
INPUT_FILE = "./data-gpt/T-FREX/out-of-domain/COMMUNICATION/feature_extracted_data/test-set-BYsg165a-eval-opti-dft.json"
